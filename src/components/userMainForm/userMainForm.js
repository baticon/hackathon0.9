        ...
        <form className={style.formContainer} onSubmit={handleSubmit(onSubmit)}>
          <div style={{ marginTop: "2%" }}>
            ...
            <div className={style.IINContainer}>
              ...
              <img
                ...
                alt=""
                className={style.hint}
                title="Если Вы сменили фамилию, укажите, пожалуйста, прежнюю"
              ></img>
            </div>
            <div className={style.IINContainer}>
              <label className={style.IINlabel}>Прежние ФИО</label>
              <input
                className={style.IINinput}
                placeholder="например, Абишева Айгуль Муратовна"
                // required="required"
          ...
          <div style={{ marginTop: "2%" }}>
            ...
            <div className={style.AddRemoveButtonContainer}>
              <Button
                className={style.AddButton}
                onClick={() => courseAppend({ ...defaultCourse })}
              >
                Добавить курс
              </Button>
              <Button
                className={style.RemoveButton}
                onClick={() => courseRemove({ ...defaultCourse })}
              >
                Удалить курс
              </Button>
            </div>
          ...
          <div style={{ marginTop: "2%" }}>
            ...
            <Button type="submit" className={style.finalButton}>
              Отправить
            </Button>
            <div
              style={{
